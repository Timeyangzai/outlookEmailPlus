(function () {
    ...
    const exactMap = {
        ...
        'Microsoft 验证地址': 'Microsoft Verification URL',
        '复制验证码': 'Copy Code',
        '打开验证页': 'Open Verification Page',
        '停止轮询': 'Stop Polling',
        '在打开的 Microsoft 页面输入上方验证码并完成登录，本工具会自动换取 Token。': 'Enter the code above on the Microsoft page and finish sign-in. This tool will exchange the token automatically.',
        ...
        '启动设备码登录失败': 'Failed to start device code login',
        '设备码已生成，请打开验证页完成 Microsoft 登录': 'Device code generated. Open the verification page to finish Microsoft sign-in.',
        '等待 Microsoft 登录确认': 'Waiting for Microsoft sign-in confirmation',
        '设备码已生成，请完成 Microsoft 登录': 'Device code generated. Finish Microsoft sign-in.',
        '设备码登录失败': 'Device code login failed',
        '设备码登录完成': 'Device code login complete',
        '没有可复制的验证码': 'No verification code to copy',
        '没有可打开的验证页': 'No verification page to open',
        '已停止设备码轮询': 'Device code polling stopped',
